...
power_active_stuff = '''Воу-воу братишка, ты походу переутомился! \U0001F4AAСила -5'''
power_active_too_much = '''Ты пошел на лишнее повторение и уронил штангу на грудь. \U00002764 Здоровье -5'''
power_active_stop = '''Закончил упражнение. \U0001F4AA Сила +%s'''
