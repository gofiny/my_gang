...
you_disconnected = '''Ты отключен от сервера за бездействие'''
link_account = '''Твой token %s\nЕсли хочешь привязить свой аккаунт в боте %s, пройди в этот раздел в боте %s и нажми кнопку "Привязать"'''
send_link_token = '''Отправь токен аккаунта, который хочешь привязать сюда:'''
sure_to_link = '''Ты уверен что хочешь привязать %s аккаунт сюда? Аккаунт с которого ты сейчас играешь будет удален'''
account_linked = '''Четко! Аккаунт привязан.'''
settings = '''Настройки:'''
finish_actions = '''Тебе нужно завершить все действия и выйти на улицу или домой, чтобы отключится'''
disconnected = '''Ты отключен от сервера'''
