...
health_active_choose_way = '''будет картинка %s . \U0001F501 Дистанция: %s/10м'''
health_active_stop = '''Та закончил бегать. n\U00002764 Здоровье +%s'''
health_active_too_much = '''Ты переутомился, и упал в обморок. \n\U00002764 Здоровье -5'''
health_lets_finish = '''Заканчивай бегать! %s . \U0001F501 Дистанция: %s/10м'''
